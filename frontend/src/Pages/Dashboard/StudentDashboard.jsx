      ...
      <div className="flex flex-1">
        ...
        <div className="p-6 w-full bg-gray-50 min-h-screen">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card title="Resources" value="120" icon={<FaBook />} color="bg-blue-100" />

            <Card title="Events" value="8" icon={<FaCalendarAlt />} color="bg-green-100" />

            <Card title="Internships" value="15" icon={<FaBriefcase />} color="bg-purple-100" />

            <Card title="Complaints" value="3" icon={<FaExclamationCircle />} color="bg-orange-100" />
